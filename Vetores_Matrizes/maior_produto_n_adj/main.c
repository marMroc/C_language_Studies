...
cadas em negrito. O produto desses numerose 26 * 63* 78 * 14 = 1788696. 
...
Qual e o maior produto de quatro numeros adjacentes em qualquer direcao (cima, baixo, ˜
...
int main() {
    ...
    // Verificando produtos diagonais de esquerda para direita
    for (int i = 0; i < ROWS - 3; i++) {
        for (int j = 0; j < COLS - 3; j++) {
    ...
    // Verificando produtos diagonais de direita para esquerda
    for (int i = 0; i < ROWS - 3; i++) {
    ...
    printf("O maior produto de quatro números adjacentes na matriz é: %d", maxProduct);
